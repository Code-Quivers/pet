...
const PromoCodeDeleteConfirmationModal = ({
  isOpenDelete,
  handleCloseDelete,
  deleteData,
}: any) => {
  const [deletePromo, { data, isSuccess, isError, isLoading, error, reset }] =
          ...
          <div className=" ">
            ...
            <div className="p-3  mt-5 bg-[#feeddd] rounded-lg ">
              ...
              <p className="text-[#b53a07] text-sm font-medium">
                By deleting this Promotion Offer , you will not be able to undo
                this action
              </p>
            </div>
...
export default PromoCodeDeleteConfirmationModal;
