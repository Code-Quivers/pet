...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0  flex h-screen w-60 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0 z-999999" : "-translate-x-full z-10"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
        ...
        <nav className="py-4 px-4 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Products
                        <svg
                          className={`absolute right-4 duration-300 ease-in-out transition-all top-1/2 -translate-y-1/2 fill-current ${
                            open && "rotate-180"
                          }`}
                          width="20"
                          height="20"
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out 
                              hover:text-white ${
                                pathname === "/products/ad" && "text-white"
                              } `}
                            >
                              Ad Section
                            </Link>
              ...
              <SidebarLinkGroup
                activeCondition={pathname.includes("order-reports")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname.includes("order-reports") &&
                          "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/order-reports"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/order-reports" && "text-white"
                              } `}
                            >
                              All Orders
                            </Link>
              ...
              <li>
                <Link
                  href="/testimonial"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/testimonial" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <ImList2 />
                  Testimonial
              ...
              <li>
                <Link
                  href="/client-list"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/client-list" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <ImList2 />
                  Client List
              ...
              <li>
                <Link
                  href="/tax-settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/tax-settings" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <ImList2 />
                  Tax Settings
