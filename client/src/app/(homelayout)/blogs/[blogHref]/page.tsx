...
import SingleBlogComment from "@/components/Blog/SingleBlogComment";
        ...
        <div className="py-8">
          <div className="mx-auto">
            ...
            <p className="text-gray-600">
              Published on {moment(blogDetails?.data?.createdAt).format("LLL")}
            </p>
          </div>
        </div>
          ...
          <div className="container mx-auto  flex flex-col md:flex-row">
            <div className="w-full md:w-2/3">
              <Image
                ...
                src={`${fileUrlKey()}/${blogDetails?.data?.blogImage}`}
              ...
              {/* all comments */}
              <div className="mt-8">
                <SingleBlogComment blogHref={params?.blogHref} />
              </div>
              <div>
                <BlogComments blogHref={params?.blogHref} />
              </div>
            </div>
            {/* Side bar */}
