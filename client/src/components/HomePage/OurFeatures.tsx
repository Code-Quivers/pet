      ...
      <div className="max-w-6xl mx-auto font-[sans-serif] text-[#333]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 md:grid-cols-2">
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">NO Charging Ever</h3>
            {/* <p className="text-gray-500 text-sm">
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">NO EMFs</h3>
            {/* <p className="text-gray-500 text-sm">
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">NO Apps Required</h3>
            {/* <p className="text-gray-500 text-sm">
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">Hypo-allergenic</h3>
            {/* <p className="text-gray-500 text-sm">
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">Waterproof</h3>
            {/* <p className="text-gray-500 text-sm">
              Tailor our product to suit your needs Seamless communication for
              your team.
            </p> */}
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">Durable</h3>
            {/* <p className="text-gray-500 text-sm">
              Tailor our product to suit your needs Seamless communication for
              your team.
            </p> */}
          ...
          <div className="p-2 text-center">
            ...
            <h3 className="text-base font-semibold mb-2">Comfortable</h3>
            {/* <p className="text-gray-500 text-sm">
              Tailor our product to suit your needs Seamless communication for
              your team.
            </p> */}
